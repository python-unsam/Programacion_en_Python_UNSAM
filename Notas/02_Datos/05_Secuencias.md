...
Modificá el programa `informe.py` que escribiste antes (ver [Ejercicio 2.33](../02_Datos/08_Formato.md#ejercicio-233-un-desafío-de-formato)) para que use esta técnica para elegir las columnas a partir de sus encabezados.
