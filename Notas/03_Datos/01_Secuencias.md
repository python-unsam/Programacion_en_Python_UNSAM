...
Modificá el programa `informe.py` que escribiste antes (ver [Ejercicio 2.15](../02_Estructuras_y_Funciones/04_Contenedores.md#ejercicio-215-balances)) para que use esta técnica para elegir las columnas a partir de sus encabezados.
