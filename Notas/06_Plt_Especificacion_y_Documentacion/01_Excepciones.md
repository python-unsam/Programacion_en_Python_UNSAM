...
La función `parse_csv()` que escribiste en el Ejercicio ? admite seleccionar algunas columnas por el usuario, pero eso sólo funciona si el archivo de entrada tiene encabezados.
