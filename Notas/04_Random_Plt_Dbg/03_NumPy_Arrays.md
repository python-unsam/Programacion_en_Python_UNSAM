...
Ampliá el código de `termometro.py` que escribiste en el [Ejercicio 4.6](../04_Random_Plt_Dbg/02_Random.md#ejercicio-46-gaussiana) para que guarde el vector con las temperaturas simuladas en el directorio `Data` de tu carpeta de ejercicios, en un archivo llamado `Temperaturas.npy`. Hacé que corra 999 veces en lugar de solo 99.
