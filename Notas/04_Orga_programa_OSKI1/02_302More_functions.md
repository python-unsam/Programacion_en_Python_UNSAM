[Contenidos](../Contenidos.md) \| [Anterior (1 Scripting)](01_301Script.md) \| [Próximo (3 Búsqueda binaria*)](03_BusqBinaria.md)
...
Cuando llamás a una función, las variables argumento (o simplemente los "argumentos") son los nombres que refieren a los valores que le pasás. Estos valores no son copias de los originales. (ver sección [Sección 3.3](../03_Mas_Python/03_Objects.md#33-objetos) ) Si le pasás tipos mutables, como listas ó diccionarios, la función *si* los puede modificar.
...
### Ejercicio 4.4: Selector de Columnas
...
Vimos un ejemplo de un selector de columnas en el [Ejercicio 3.5](../03_Mas_Python/02_List_comprehension.md#ejercicio-35-estraer-datos-de-una-arhcivo-csv)
