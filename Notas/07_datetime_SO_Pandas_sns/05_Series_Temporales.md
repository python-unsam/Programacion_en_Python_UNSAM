...
Estimá la diferencia en los ceros de escala de ambos puertos. Usá estos datos para volver a hacer el gráfico del \ref_ej{ej_mareas_a_mano} (vas a tener que redondear a horas enteras el delay temporal).

## Un poco más avanzados:

### Ejercicio: Otros puertos
\label_ej{ej_mareas_fft}
