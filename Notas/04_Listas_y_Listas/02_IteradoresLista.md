...
En esta solución lo ideal es usar `enumerate` (ver la [Sección 3.3](../03_Datos/03_Secuencias.md#la-función-enumerate)) ya que dentro de la iteración necesitamos tener acceso tanto al valor del elemento (para ver si es igual al buscado) como a su índice (es el valor que tenemos que devolver).
...
![Propagación](./fosforos.jpg) Propagación análoga a la del [Ejercicio 4.6](../04_Listas_y_Listas/02_IteradoresLista.md#ejercicio-46-propagacion)
